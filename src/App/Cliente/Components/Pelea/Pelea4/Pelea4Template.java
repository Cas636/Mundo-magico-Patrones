...
public class Pelea4Template extends JPanel{
    ...
    public void crearLabel() {
       ...
       //label 
        ...
        this.add(lab1);
        // redimencionar jefe
        iDim= new ImageIcon(sRecursos.getImagenMago4().getImage().getScaledInstance(200, 248, Image.SCALE_AREA_AVERAGING));
       //label 
        lab2= sObjGrafics.construirJLabel("",840,185, 200, 248,
        null, iDim, null, null, null, null, "");
        this.add(lab2);
        // redimencionar mundo magico
        iDim= new ImageIcon(sRecursos.getImagenFondoPelea4().getImage().getScaledInstance(1500, 680, Image.SCALE_AREA_AVERAGING));
       //label 
